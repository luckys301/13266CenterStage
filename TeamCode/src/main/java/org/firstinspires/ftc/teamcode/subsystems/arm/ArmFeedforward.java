...
public class ArmFeedforward extends Arm {
    //Zero HAS TO be parallel to the ground and encoder needs to be in radians
    protected com.arcrobotics.ftclib.controller.wpilibcontroller.ArmFeedforward armFeedforward;
    ...
    public ArmFeedforward(Telemetry tl, HardwareMap hw, boolean isEnabled) {
        super(tl, hw, isEnabled);

        armFeedforward = new com.arcrobotics.ftclib.controller.wpilibcontroller.ArmFeedforward(
            NebulaConstants.Arm.ks,
            NebulaConstants.Arm.kcos,
            NebulaConstants.Arm.ka,
            NebulaConstants.Arm.kv);
