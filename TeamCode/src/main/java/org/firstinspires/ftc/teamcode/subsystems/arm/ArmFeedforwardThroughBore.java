...
public class ArmFeedforwardThroughBore extends ArmFeedforward {
    protected final Encoder armEncoder;// Plugged into Motor
    public ArmFeedforwardThroughBore(Telemetry tl, HardwareMap hw, boolean isEnabled) {
        super(tl, hw, isEnabled);
        armEncoder = new Encoder(
            hw.get(DcMotorEx.class, NebulaConstants.Arm.armMName));
